...
**Method**:
```js
og.getBalance().then(function(data){});
```
**Return**:
```json
{ "data":
...
**Method**:
```js
og.getNonce().then(function(data){});
```
**Return**:
```json
{ 
...
**Method**:
```js
og.getReceipt().then(function(data){});
```
**Return**:
```json
{ "data":
...
**Method**:
```js
og.getTransaction().then(function(data){});
```
**Return**:
```json
{ "data":
